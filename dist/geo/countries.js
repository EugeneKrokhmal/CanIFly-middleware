...
export const LITHUANIA_COUNTRY = {
    id: "LT",
    iso2: "LT",
    iso3: "LTU",
    nameEn: "Lithuania",
...
export const ESTONIA_COUNTRY = {
    ...
    official: {
        ...
        authorityUrl: "https://www.transpordiamet.ee/en/aviation-and-aviation-safety/flying-drones-estonia/geographical-zones",
        authorityName: "EANS / Transpordiamet",
    },
};
/** Slovakia (NSAT / Dopravný úrad KML geozones). */
export const SLOVAKIA_COUNTRY = {
    id: "SK",
    iso2: "SK",
    iso3: "SVK",
    nameEn: "Slovakia",
