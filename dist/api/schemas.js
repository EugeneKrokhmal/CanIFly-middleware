...
export const appLocaleSchema = z.enum(["es", "en", "de", "fr", "pl", "cs"]);
...
export const createObstacleSchema = z
    ...
    const allowed = data.kind === "fly_spot" ? FLY_SPOT_ONLY : OBSTACLE_ONLY;
...
export function openCategoryCeiling(altitudeAgl) {
