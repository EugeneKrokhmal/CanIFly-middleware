import { COUNTRIES, AUSTRIA_COUNTRY, DENMARK_COUNTRY, FRANCE_COUNTRY, GERMANY_COUNTRY, PORTUGAL_COUNTRY, SPAIN_COUNTRY, SWEDEN_COUNTRY, IRELAND_COUNTRY, LATVIA_COUNTRY, LITHUANIA_COUNTRY, ESTONIA_COUNTRY, SLOVAKIA_COUNTRY, SLOVENIA_COUNTRY, SWITZERLAND_COUNTRY, } from "./geo/countries.js";
...
export const LATVIA_CENTER = LATVIA_COUNTRY.center;
export const LITHUANIA_CENTER = LITHUANIA_COUNTRY.center;
export const ESTONIA_CENTER = ESTONIA_COUNTRY.center;
export const SLOVAKIA_CENTER = SLOVAKIA_COUNTRY.center;
export const SLOVENIA_CENTER = SLOVENIA_COUNTRY.center;
